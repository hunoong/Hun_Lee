...
// introduction for users
  fill(160);
  textSize(14);
  text('This work is originally intended to track the algorithmic movements of birds. However, it can also track other objects too.', windowWidth/2,windowHeight-70);
  text('It might take some time to launch the detector. If the bird cursor is following, then it is good to go.', windowWidth/2,windowHeight-50);  
...
//---brushes for living creatures------------------------------------------------
    if(detection.label === 'person','bird'){ 
    ...
    else if(detection.label === 'cat','dog'){
...
//---brushes for objects----------------------------------------------------------
    ...
    else if(detection.label === 'book,scissors'){  
